        ...
        if (isAdmin) {
          ...
          coursesData = allCategories.map((category: any) => ({
            ...
            course: {
              ...
              target_en: category.target_en || '',
              modalidad: category.modalidad || '',
              modalidad_en: category.modalidad_en || '',
              learn: category.learn || '',
              learn_en: category.learn_en || '',
              includes_category: category.includes_category || [],
              includes_category_en: category.includes_category_en || [],
