...
export default function LessonContent({
  ...
  const lessonExtras = {
    'lesson-1': {
      materials: [
        {
          type: 'pdf',
          title: 'Manual de Introducción al Tatuaje Cosmético',
          size: '2.5 MB',
        },
        {
          type: 'pdf',
          title: 'Guía de Herramientas y Materiales',
          size: '1.8 MB',
        },
      ...
      notes:
        'En esta lección aprenderás los fundamentos básicos del tatuaje cosmético, incluyendo la preparación del área de trabajo y las herramientas esenciales.',
    },
    'lesson-2': {
      materials: [], // Solo explicativo, sin descargas
      notes:
        'Domina las técnicas avanzadas de aplicación de pigmentos para lograr resultados naturales y duraderos. Esta lección es puramente explicativa.',
    },
    'lesson-3': {
      materials: [], // Solo explicativo, sin descargas
      notes:
        'Comprende la estructura facial para crear diseños personalizados que realcen la belleza natural de cada cliente. Contenido teórico especializado.',
    },
    'lesson-4': {
      materials: [],
      notes:
        'Introducción a la técnica revolucionaria de nanoblading para cejas ultra naturales.',
    },
    'lesson-5': {
      materials: [],
  ...
  return (
    <div
      className={`bg-[#2d2d2d]/80 backdrop-blur-sm rounded-lg shadow-xl border border-gray-700 ${className}`}
    >
      ...
      <div className='p-6'>
        ...
        {extras.notes && (
          <div className='bg-[#f9bbc4]/10 border border-[#f9bbc4]/30 p-4 rounded-lg mb-6'>
            <h4 className='font-medium text-[#f9bbc4] mb-2'>
              Notas importantes:
            </h4>
        ...
        {extras.materials.length > 0 && (
          <div className='space-y-3'>
            {extras.materials.map((material, index) => (
              <div
                key={index}
                className='flex items-center justify-between p-4 bg-[#3d3d3d]/50 rounded-lg border border-gray-600 hover:bg-[#3d3d3d]/70 transition-all duration-200'
              >
