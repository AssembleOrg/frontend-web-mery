...
export default function PromoModal() {
  ...
  return (
    <>
      ...
      {/* Modal */}
      <div className='fixed inset-0 z-[70] flex items-center justify-center p-4 md:p-4 pointer-events-none'>
        <div
          className='rounded-xl md:rounded-2xl max-w-[320px] md:max-w-lg w-full p-4 md:p-8 relative pointer-events-auto overflow-hidden'
        ...
        >
          ...
          {/* Contenido */}
          <div className='text-center space-y-3 md:space-y-6 font-admin relative z-10'>
            {/* Badge de descuento */}
            <div className='inline-flex items-center justify-center'>
              <div className='bg-[#8b1538] text-white px-4 py-1 md:px-6 md:py-2 rounded-full text-xs md:text-sm font-bold tracking-wider'>
                ¡OFERTA ESPECIAL!
              </div>
            </div>
            ...
            <div className='space-y-1'>
              <h2 className='text-3xl md:text-4xl font-bold text-[#8b1538]'>
                {PROMO_CONFIG.TEXTS.modalTitle}
              </h2>
              <p className='text-sm md:text-xl font-semibold text-[var(--mg-dark)]'>
            ...
            <div className='space-y-1'>
              <p className='text-xs md:text-base text-[var(--mg-dark)]'>
                Empezá el año con una oportunidad de llevar tu profesión a otro nivel.
              </p>
              <p className='text-xs md:text-lg font-black text-[var(--mg-dark)]'>
            ...
            <div className='py-2 md:py-6'>
              {isCountdownZero ? (
                <div className='space-y-2 md:space-y-3'>
                  <p className='text-xs md:text-lg font-medium text-gray-400'>
                  ...
                  <div className='flex justify-center gap-2 md:gap-3'>
                    {[
                      ...
                      >
                        <div className='bg-gray-200 text-gray-400 rounded-lg px-2 py-1.5 md:px-3 md:py-2 min-w-[40px] md:min-w-[60px] font-mono text-base md:text-2xl font-bold'>
                          {item.value}
                        </div>
                ...
                <div className='space-y-2 md:space-y-3'>
                  ...
                  <div className='flex justify-center gap-2 md:gap-3'>
                    {[
                      ...
                      >
                        <div
                          className='text-[#8b1538] rounded-lg px-2 py-1.5 md:px-3 md:py-2 min-w-[40px] md:min-w-[60px] font-mono text-base md:text-2xl font-bold bg-white/50'
                        >
                          {item.value}
                        </div>
                        <span className='text-[10px] md:text-xs text-[var(--mg-gray)] mt-1 font-medium'>
                          {item.label}
                        </span>
                      </div>
                    ))}
            ...
            <button
              onClick={handleCTA}
              className='w-full bg-[#f9bbc4] hover:bg-[#eba2a8] text-white font-bold py-3 px-4 md:py-4 md:px-8 rounded-lg md:rounded-xl transition-colors duration-200 text-sm md:text-base'
            >
