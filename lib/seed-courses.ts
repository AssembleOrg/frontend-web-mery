// TEMP: Script to seed initial course data from hardcoded data
// TODO: Remove this file when backend is ready

import { Course } from '@/types/course';

/**
 * Initial courses data migrated from app/[locale]/formaciones/page.tsx
 * This will be used to seed the admin store on first load
 */
export const initialCourses: Course[] = [
  {
    ...
    currency: 'ARS',
    description: 'Formación Online Completa.Incluye la técnica Refill created by Mery Garcia',
    isPublished: true,
    modalContent: {
      detailedDescription:
  ...
  },
  {
    ...
    priceDisplay: '$80.000',
    currency: 'ARS',
    description: 'Formación Online. Tecnica exclusiva creada por MG. Requiere experiencia previa.',
    isPublished: true,
    modalContent: {
      detailedDescription:
