          ...
          <div className='prose prose-sm md:prose-base max-w-none'>
            <div className='space-y-8 text-foreground'>
              ...
              <section>
                ...
                <div className='space-y-4 text-foreground leading-relaxed'>
                  <p>
                    ...
                    &quot;Términos y Condiciones&quot;) regulan la relación
                    entre MERY GARCÍA y Usted como Usuario de los Servicios,
                    entendiéndose el término &quot;Usuario&quot; como toda
                    aquella persona física que participe de los programas
                    ofrecidos por MERY GARCÍA, incluyendo participantes,
                    asistentes, inscriptos, oyentes y entendiéndose el término
                    &quot;Servicio/s&quot; como todo programa, curso, ponencia,
                    exposición ofrecida, tutorial, videos explicativos, archivo
                    pdf, ofrecidos por MERY GARCIA.
                  </p>
                  <p>
                    Al acceder al Servicio y a la plataforma, entendiéndose el
                    término &quot;Plataforma&quot;, como el medio web de acceso
                    a los Servicios, el Usuario se compromete a cumplir y
                    aceptar todos los Términos y Condiciones que aparecen a
                    continuación. El presente documento constituye el
                    instrumento que contemplará los Términos de Uso del Servicio
                    que se aplicarán y resultarán obligatorios para todos los
                    usuarios que adquieran Servicios a MERY GARCIA.
                  </p>
                  <p>
                  ...
                  <p>
                    ...
                    Usuario revisar periódicamente por cambios en estos Términos
                    y Condiciones. El uso continuo de los Servicios después de
                    la publicación de cambios, significará que acepta y está de
              ...
              <section>
                ...
                <div className='space-y-4 text-foreground leading-relaxed'>
                  <div>
                    ...
                    <p className='mt-2'>
                      Todo esto durante 12 (doce) meses corridos desde la compra
                      de la Formación.
                    </p>
                  </div>
                  <p>
              ...
              <section>
                ...
                <div className='space-y-4 text-foreground leading-relaxed'>
                  <p>
                    ...
                    los Servicios todas las personas humanas con capacidad legal
                    para contratar.
                  </p>
                  <p>
                  ...
                  <p>
                    ...
                    terceras personas puedan acceder a ellas, quedando entendido
                    que cualquier acción realizada en la plataforma mediante el
                    nombre de usuario y contraseña elegidos por el Usuario será
                    imputada a dicho Usuario.
                  </p>
                  <p>
                    <span className='font-semibold'>2.5</span> El acceso a la
                    información del usuario queda restringido al propio usuario
                    mediante el uso de su &quot;palabra clave&quot; o
                    contraseña.
                  </p>
                  <p>
                  ...
                  <p>
                    <span className='font-semibold'>2.9</span> MERY GARCIA podrá
                    rechazar cualquier solicitud de registro o impedir en
              ...
              <section>
                ...
                <div className='space-y-4 text-foreground leading-relaxed'>
                  <p>
                    ...
                    Condiciones del servicio y la utilización de éste. El uso de
                    los Servicios / Capacitaciones / Formaciones que se ofrecen
                    implica su aceptación. MERY GARCIA se reserva el derecho de
                    suspender a un participante si, en su única y exclusiva
                    opinión, no cumple con lo dispuesto por los términos y
                    condiciones y/o comete o es sospechado de cometer alguna
                    actividad que pudiere vulnerar los derechos de MERY GARCIA.
                    El Usuario no tendrá derecho a ningún tipo de acción y/o
                    reclamo en tal sentido, renunciando a través del presente a
                    efectuar los mismos.
                  </p>
                </div>
              </section>
              ...
              <section>
                ...
                <div className='space-y-4 text-foreground leading-relaxed'>
                  <p>
                    ...
                    infringirá los derechos de terceros, incluyendo los derechos
                    de autor, marca, privacidad, publicidad u otros derechos
                    personales o de propiedad intelectual; y que no incluirán
                    ningún contenido denigrante, difamatorio o ilegal.
                  </p>
                </div>
              </section>
              ...
              <section>
                ...
                <div className='space-y-4 text-foreground leading-relaxed'>
                  <p>
                    <span className='font-semibold'>6.1</span> El Usuario deberá
                    utilizar la Plataforma de conformidad con las disposiciones
                    establecidas en estos Términos y Condiciones, con el
                    ordenamiento jurídico vigente en la República Argentina y
                    según las pautas de conducta impuestas por la moral, las
                    buenas costumbres y el debido respecto a los derechos de
                    terceros.
                  </p>
                  <p>
                    ...
                    sitio web o entorno informático para cualquier propósito sin
                    la autorización previa y por escrito de MERY GARCIA; iv)
                    interferir o interrumpir el funcionamiento de los Servicios
                    y/o de la plataforma; v) vender, licenciar o explotar el
                    contenido de los Servicios y/o cualquier tipo de acceso y/o
                    uso de la Plataforma; vi) utilizar los Servicios y/o la
                    Plataforma con fines ilícitos o inmorales, lesivos de los
                    derechos e intereses de terceros, o que de cualquier forma
                    puedan dañar, inutilizar, sobrecargar o deteriorar los
                    servicios, los equipos informáticos de otros usuarios o de
                    otros usuarios de Internet (hardware y software) así como
                    los documentos, archivos y toda clase de contenidos
                    almacenados en sus equipos informáticos, o impedir la normal
                    utilización o disfrute de dichos Servicios, equipos
                    informáticos y documentos, archivos y contenidos por parte
                    de los demás usuarios y de otros usuarios e vii) infringir
              ...
              <section>
                ...
                <div className='space-y-4 text-foreground leading-relaxed'>
                  <p>
                    <span className='font-semibold'>7.1</span> MERY GARCIA podrá
                    retirar o suspender, cautelarmente, la prestación del
                    ...
                    los eventuales daños y perjuicios que dichos incumplimientos
                    le ocasionen.
                  </p>
                </div>
              </section>
              ...
              <section>
                ...
                <div className='space-y-4 text-foreground leading-relaxed'>
                  <p>
                    ...
                    datos, fotos, videos o contenidos de texto a MERY GARCIA (en
                    conjunto los &quot;Archivos de Usuario&quot;) por cualquier
                    medio de transmisión, incluyendo pero no limitado a,
                    publicar, cargar, ingresar, proporcionar o enviar cualquiera
                    de los Archivos de Usuario a través del uso de la
                    plataforma, usted entonces está otorgando a MERY GARCIA
                    permiso de usar sus Archivos de Usuario en operaciones en
                    relación con el funcionamiento de su negocio, incluyendo,
                    sin limitación, los derechos a: reproducir, editar, traducir
                    y dar formato a sus Archivos de Usuario dentro de la
                    plataforma y dentro del marco de privacidad el Usuario para
                    un mejor servicio al Usuario.
                  </p>
                  <p>
                    <span className='font-semibold'>8.2</span> Ninguna
                    compensación se pagará con respecto al uso por parte de MERY
                    GARCIA de los Archivos de Usuario, según lo dispuesto en
                    este documento, ni MERY GARCIA estará obligado a publicar o
                    utilizar los Archivos de Usuario.
                  </p>
                </div>
              </section>
              ...
              <section>
                ...
                <div className='space-y-4 text-foreground leading-relaxed'>
                  <p>
                    ...
                    Privacidad&quot;) los términos &quot;datos personales&quot;,
                    &quot;datos sensibles&quot;, &quot;base de datos&quot;,
                    &quot;tratamiento de datos&quot;, &quot;responsable de la
                    base de datos&quot;, &quot;datos informatizados&quot;,
                    &quot;titular de los datos&quot;, &quot;usuario de
                    datos&quot; y &quot;disociación de datos&quot; tendrán el
                    significado asignado por el artículo 2 de la Ley de
                    Protección de Datos Personales y Habeas Data Nº 25.326 (en
                    adelante, la &quot;LPDP&quot;).
                  </p>
                  <p>
                    <span className='font-semibold'>9.2</span> En particular,
                    MERY GARCIA cumple con todos los principios que surgen de la
                    Normativa de Protección de Datos Personales, que incluyen
                    pero no se limitan a: i) el principio de legalidad, dado que
                    la base de datos en la que se almacenarán los datos
                    recolectados a través de la Plataforma se encuentra
                    debidamente registrada; ii) el principio de calidad dado que
                    MERY GARCIA únicamente recolecta aquellos datos personales
                    que resultan necesarios y adecuados para la prestación de
                    sus servicios y el uso de la Plataforma, y lo hace por
                    medios leales y respetando la intimidad de los titulares de
                    dichos datos personales; iii) el principio de finalidad,
                    dado que MERY GARCIA utiliza los datos personales recabados
                    únicamente para el fin para el que fueron recolectados; iv)
                    el principio de consentimiento informado, dado que MERY
                    GARCIA recaba el consentimiento de los titulares de los
                    datos personales en forma prescripta por la LPDP siempre que
                    ello resulta necesario por no encontrarse en alguna de las
                    excepciones de dicha norma; y v) los principios de seguridad
                    y confidencialidad de la información, mediante la
                    utilización de tecnología avanzada que permite resguardar
                    adecuadamente –según el estado de la técnica- la
                    confidencialidad y seguridad de la información. Asimismo,
                    para garantizar la seguridad de los datos, MERY GARCIA
                    aplicará los mismos criterios y el mismo grado de diligencia
                    que aplica para resguardar su propia información.
                  </p>
                  <p>
                    <span className='font-semibold'>9.3</span> El Usuario presta
                    su consentimiento expreso para que MERY GARCIA trate los
                    datos personales que el Usuario declare (incluyendo pero sin
                    limitarse al nombre, DNI, CUIT/CUIL, edad, domicilio,
                    antecedentes) como así también información de
                  ...
                  <p>
                    ...
                    Plataforma, como así también los que la Plataforma recolecte
                    en forma automatizada serán almacenados en una base de datos
                    de titularidad de MERY GARCIA (en adelante, la &quot;Base de
                    Datos&quot;).
                  </p>
                  <p>
              ...
              <section>
                ...
                <div className='space-y-4 text-foreground leading-relaxed'>
                  <p>
                    ...
                    transmita a través de ellos son identificados y considerados
                    de carácter confidencial de MERY GARCIA. En consecuencia, el
                    Usuario se compromete en forma irrevocable a mantener en
                    forma confidencial la Información que reciba de MERY GARCIA
                    bajo este compromiso de confidencialidad (en adelante, el
                    &quot;Compromiso&quot;). Este Compromiso tendrá vigencia
                    desde la fecha de aceptación de los presentes términos y
                    condiciones.
                  </p>
                  <p>
                    <span className='font-semibold'>10.2</span> El término
                    &quot;Información&quot; como se utiliza en el Compromiso
                    comprende la totalidad de la información contenida en la
                    base de datos, suministrada por MERY GARCIA al Usuario con
                    anterioridad o con posterioridad a este Compromiso,
                    cualquiera fuere la modalidad de su formación,
                    almacenamiento, organización o acceso. Asimismo, el término
                    &quot;Información&quot; incluirá todos los datos, listas de
                    clientes, informes, contratos, compilaciones, información
                    estadística, y cualquier material proveniente o producido
                    por MERY GARCIA, sus representantes o terceras personas y
                    que sea compartido por MERY GARCIA con el Usuario.
                  </p>
                  <p>
                    <span className='font-semibold'>10.3</span> El término
                    &quot;Información&quot; no incluye aquella información (i)
                    que ya fuere conocida por el público en general sin que esto
                    se deba al accionar indebido del Usuario o (ii) cuya
                    divulgación haya sido expresamente autorizada por MERY
                    GARCIA. Tampoco incluirá aquella información que haya sido o
                    sea requerida por una autoridad judicial o administrativa
                    con facultades suficientes para ello. En todos los casos, el
                    Usuario será responsable de demostrar sus derechos con
                  ...
                  <p>
                    ...
                    limitarse el uso de la misma para los fines que expresamente
                    indique MERY GARCIA, debiendo luego de su uso restituir a
                    MERY GARCIA la Información recibida y destruir todo registro
                    que pudiera haber quedado de la misma.
                  </p>
                  <p>
                  ...
                  <p>
                    <span className='font-semibold'>10.7</span> Las obligaciones
                    de confidencialidad asumidas por el Usuario en este
                    Compromiso mantendrán su vigencia durante todo el tiempo que
                    dure la relación entre el Usuario y MERY GARCIA, así como
                    por un plazo adicional de dos (2) años a partir de la fecha
                    de terminación de la referida relación, independientemente
                    del motivo que llevó a dicha terminación, con hasta un
                    máximo de diez (10) años de suscripto el Compromiso, lo que
                    ocurra primero.
                  </p>
                  <p>
                ...
                <div className='space-y-4 text-foreground leading-relaxed'>
                  ...
                  <ul className='list-disc pl-6 space-y-2'>
                    ...
                    <li>
                      ...
                      causal, pérdida de datos o información, pérdida de chance,
                      daños punitivos ni de cualquier otra naturaleza derivadas
                    ...
                    <li>
                      ...
                      datos derivada del uso de los Servicios y/o la Plataforma,
                      salvo que medie dolo de MERY GARCIA.
                    </li>
                    <li>
                      Ningún daño y/o perjuicio que por cualquier causa
              ...
              <section>
                ...
                <div className='space-y-4 text-foreground leading-relaxed'>
                  <p>
                    ...
                    honorarios razonables de abogados que surjan de su uso o mal
                    uso de los Servicios, incluyendo sin limitación, el
                  ...
                  <p>
                    ...
                    reserva el derecho, a expensas propias, de asumir la defensa
                    y control exclusivo de cualquier asunto sujeto a
              ...
              <section>
                ...
                <div className='space-y-4 text-foreground leading-relaxed'>
                  <p>
                    ...
                    textos, ilustraciones, íconos, logo e isotipos, fotografías,
                    programas, animaciones, cualquier música, melodía, video
                    clip y cualquier otro elemento que forma parte del Website
                    sólo tiene como destino la comercialización de servicios por
                    parte de MERY GARCIA, y se encuentra prohibida cualquier
                    reproducción, modificación o distribución de los mismos.
                  </p>
                  <p>
                    ...
                    licenciamiento. A título meramente enunciativo se entenderán
                    incluidos las imágenes, fotografías, diseños, gráficos,
                    sonidos, compilaciones de datos, marcas, nombre, títulos,
                    designaciones, signos distintivos, y todo otro material
                  ...
                  <p>
                    ...
                    propiedad intelectual respecto de los criterios de selección
                    y/o disposición del contenido en la Plataforma corresponden
                    exclusivamente a MERY GARCIA, quedando estrictamente
                    prohibido al Usuario utilizar los contenidos, las categorías
                    y/o cualquier información de la Plataforma con otra
                    finalidad distinta a la indicada en los presentes Términos y
                    Condiciones.
                  </p>
                  <p>
              ...
              <section>
                ...
                <div className='space-y-4 text-foreground leading-relaxed'>
                  <p>
                    ...
                    garantiza el pleno acceso y operatividad de la Plataforma en
                  ...
                  <p>
                    ...
                    y/o indisponibilidad del servicio.
                  </p>
                </div>
              </section>
              ...
              <section>
                ...
                <div className='space-y-4 text-foreground leading-relaxed'>
                  <p>
                    ...
                    informar al Usuario sobre circunstancias relacionadas con el
                    uso de la Plataforma y/o estos Términos y Condiciones.
                  </p>
                </div>
              </section>
              ...
              <section>
                ...
                <div className='space-y-4 text-foreground leading-relaxed'>
                  <p>
                    <span className='font-semibold'>16.1</span> Estos Términos y
                    Condiciones, así como los derechos y obligaciones, no podrán
                    ser cedidos por usted, ni en su totalidad ni en parte, sin
                    el previo consentimiento de MERY GARCIA y cualquier intento
                    de hacerlo sin dicho consentimiento será nulo y sin efecto,
                    y se considerará un incumplimiento sustancial de los
                    Términos y Condiciones. MERY GARCIA podrá ceder, en su
                    totalidad o en parte, a su entera discreción, cualquier
                    derecho y obligación a un afiliado o a un tercero.
                  </p>
                </div>
              </section>
              ...
              <section>
                ...
                <div className='space-y-4 text-foreground leading-relaxed'>
                  <p>
                    <span className='font-semibold'>17.1</span> Los encabezados
                    de estos Términos y Condiciones han sido insertados
                    únicamente para facilitar la consulta, y no deben modificar
                    de ninguna manera el significado o el alcance de las
                    disposiciones del presente. Cuando sea apropiado, el número
                    singular que aquí se establece, se interpretará como el
                    número plural, y el género se interpretará como masculino,
                    femenino o neutro, según dicte el contexto.
                  </p>
                </div>
              </section>
              ...
              <section>
                ...
                <div className='space-y-4 text-foreground leading-relaxed'>
                  <p>
                    ...
                    ejercicio de un derecho o recurso previsto en los Términos y
                    Condiciones, constituye una renuncia a dicho derecho o
                    recurso. Todos los derechos establecidos en este documento
                    serán acumulativos y no alternativos. La renuncia a un
                    derecho no se interpretará como la renuncia a cualquier otro
                    derecho.
                  </p>
                </div>
              </section>
              ...
              <section>
                ...
                <div className='space-y-4 text-foreground leading-relaxed'>
                  <p>
                    <span className='font-semibold'>19.1</span> Estos Términos y
                    Condiciones, los Servicios y la Plataforma se rigen por la
                    legislación vigente en la República Argentina y deberán ser
                    interpretados de acuerdo con ella.
                  </p>
                  <p>
                    <span className='font-semibold'>19.2</span> El Usuario se
                    somete a todos los efectos judiciales y extrajudiciales a la
                    jurisdicción de los Tribunales Nacionales de la Ciudad
              ...
              <section>
                ...
                <div className='space-y-4 text-foreground leading-relaxed'>
                  <p>
                    <span className='font-semibold'>20.1</span> Estos Términos y
                    Condiciones constituyen el acuerdo completo de todas las
                  ...
                  <p>
                    ...
                    disposición de los Términos y Condiciones, ni en el resto de
                    dicho artículo, párrafo o disposición, a menos que se
