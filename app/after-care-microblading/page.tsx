...
export default function MicrobladingAftercarePage() {
  return (
    <div
    ...
    >
      ...
      >
        ...
        >
          ¡Felicitaciones por tus nuevas cejas!
        </p>
        <Separator />

        <p style={{ marginBottom: '15px' }}>
          Los mejores resultados vienen del &quot;no hacer nada&quot; o cuidados
          en seco. Mantener las cejas secas por los próximos 10 días hará que
          retengan el color, el detalle y la frescura, así que vale la pena.
        </p>
        <Separator />
        ...
        <p style={{ marginBottom: '15px' }}>
          No apliques ningún producto con derivadas del petróleo y NO uses
          cremas cicatrizantes. No coloques en tus cejas ningún producto contra
          el acné, cremas que aclaren la piel, ácidos glicólicos, retinoicos,
          etc., durante la cicatrización.
        </p>
        <Separator />
        ...
        <p style={{ marginBottom: '20px' }}>
          ...
          sesión de microblading. Evitá hacerlo antes para no perjudicar el
        ...
        <p style={{ marginBottom: '15px' }}>
          ...
          La segunda sesión será para terminar de definir tu forma, retocar
          lugares claritos y evaluar como reacciona tu piel al proceso y al
          color. Cada combinación de pigmentos está registrada en caso de que
          tengamos que realizar un retoque y ajustar el color.
        </p>
        <Separator />

        <p style={{ marginBottom: '20px' }}>
          El Microblading es un tratamiento de 2 sesiones. Las cejas estarán
          finalizadas luego de la segunda sesión. No existe garantías si no las
          cuidas de la manera correcta.
        </p>
        ...
        >
          ...
          <button
            onClick={() =>
              window.open(
                `https://wa.me/5491161592591?text=${encodeURIComponent('Hola chicas, como están? Tengo consultas sobre mis cuidados post microblading')}`,
                '_blank'
              )
            }
            style={{
